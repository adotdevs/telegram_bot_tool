...
export const AutoPostSchedule: Model<AutoPostScheduleDoc> =
  mongoose.models.AutoPostSchedule ??
  mongoose.model<AutoPostScheduleDoc>("AutoPostSchedule", autoPostScheduleSchema);
